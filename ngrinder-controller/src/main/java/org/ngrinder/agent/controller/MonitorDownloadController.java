...
import static org.ngrinder.agent.model.NGrinderPackage.MONITOR;
...
public class MonitorDownloadController extends BaseController {
	...
	public String download(ModelMap model) {
		try {
			final File monitorPackage = agentPackageService.createPackage(MONITOR, (URLClassLoader) getClass().getClassLoader(),
